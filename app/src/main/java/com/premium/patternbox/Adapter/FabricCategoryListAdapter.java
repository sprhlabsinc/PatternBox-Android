...
import com.premium.patternbox.FabricCategoryAddActivity;
...
public class FabricCategoryListAdapter extends  ArrayAdapter<FabricCategoryInfo> {
    private final Context mContext;
    private ArrayList<FabricCategoryInfo> dataSet;
    private int selectedPosition = -1;
    private FabricCategoryAddActivity mActivity;

    public FabricCategoryListAdapter(ArrayList<FabricCategoryInfo> data, Context context, FabricCategoryAddActivity activity) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final FabricCategoryInfo dataModel = getItem(position);
        if(itemView == null) {
