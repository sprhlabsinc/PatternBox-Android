...
public class PatternCategoryAdapter extends ArrayAdapter<PatternCategoryInfo> {
    private final Context mContext;
    private ArrayList<PatternCategoryInfo> dataSet;
    private int selectedPosition = -1;

    public PatternCategoryAdapter(ArrayList<PatternCategoryInfo> data, Context context) {
