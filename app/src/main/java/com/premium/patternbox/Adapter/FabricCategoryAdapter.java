...
public class FabricCategoryAdapter extends ArrayAdapter<FabricCategoryInfo> {
    private final Context mContext;
    private ArrayList<FabricCategoryInfo> dataSet;
    private int selectedPosition = -1;

    public FabricCategoryAdapter(ArrayList<FabricCategoryInfo> data, Context context) {
