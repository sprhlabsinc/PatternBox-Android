...
public class FabricMultiAdapter extends ArrayAdapter<FabricInfo> implements Filterable {
    ...
    public FabricMultiAdapter(ArrayList<FabricInfo> data, Context context, int userId, int[] poslist) {
