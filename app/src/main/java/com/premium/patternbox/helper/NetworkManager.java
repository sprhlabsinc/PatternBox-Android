...
public class NetworkManager {
    ...
    public NetworkManager(Context context, String tag, final Map<String, String> params, ArrayList<File> file, ArrayList<String> fileName) {
        // set null or default listener or accept as argument to constructor
        this.listener = null;
        this.context = context;
        this.session = new SessionManager(context);
        uploadImage(tag, params,file, fileName);
    }
    ...
    private void uploadImage(String tag, final Map<String, String> params, ArrayList<File> file, ArrayList<String> fileName){
        // Tag used to cancel the request
        String url = AppConfig.API_URL + tag;
        AppController.getInstance().getRequestQueue().getCache().clear();
        MultiPartRequest strReq = new MultiPartRequest(Request.Method.POST, url, file, fileName, params,
