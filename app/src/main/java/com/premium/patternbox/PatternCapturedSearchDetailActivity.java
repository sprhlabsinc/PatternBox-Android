...
public class PatternCapturedSearchDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pattern_captured_search_detail);

        pDialog = new ProgressDialog(this);
        pDialog.setCancelable(false);
        session = new SessionManager(getApplicationContext());

        Button btnFront = (Button)findViewById(R.id.btnFront);
        btnFront.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                String url =  AppConfig.downloadUrl(session.getUserID(),m_patternInfo.frontImage);
                ImageDialog dialog = new ImageDialog(PatternCapturedSearchDetailActivity.this, url);
                dialog.show();
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                String url =  AppConfig.downloadUrl(session.getUserID(),m_patternInfo.backImage);
                ImageDialog dialog = new ImageDialog(PatternCapturedSearchDetailActivity.this, url);
                dialog.show();
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case R.id.action_edit:
                Intent intent = new Intent(PatternCapturedSearchDetailActivity.this, PatternEditActivity.class);
